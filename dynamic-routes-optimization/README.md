...
- [Vehicles routing optimization with assignee minimum stops](vehicles-routing-optimization-with-assignee-minimum-stops-constraints) when we want our vehicles to adhere to a minimum number of stops.