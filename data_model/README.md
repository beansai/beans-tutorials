...
| **origination** | origination | string | "NOT_SPECIFIED" | The origin of the item, set when the item is created. WF_RETURN_TO_SENDER, MANIFEST_AMEND, MANIFEST_SYNC, MANIFEST_UPLOAD, SCANNED, CALLBACK, DISPATCH, APP, SYSTEM, NOT_SPECIFIED |
